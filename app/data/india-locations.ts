/**
 * India location snapshot generated 2026-08-27.
 * State/UT structure verified against the Government of India.
 * City data: CountryStateCity database (ODbL-1.0), kept as a static India-only snapshot.
 */
export type IndiaLocationState = { name: string; code: string; cities: string[] };
export const indiaLocations: IndiaLocationState[] = [
  {
...
export const INDIA_CITY_COUNT = 4242;
